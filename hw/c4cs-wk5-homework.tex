...
\title{\textbf{Homework 5\\Practical Regexes and Synthesis of Rich
Commands}}
\author{Assigned: Friday, February 5, 11:00AM}
\date{\textbf{\color{red}{Due: Friday, February 12, 11:00AM (Hard Deadline)}}}
\maketitle
...
\end{lstlisting}
%
\textbf{Describe in plain English what \texttt{grep -v \textquotesingle~\textbackslash*\textquotesingle} does}
\vspace{3cm}
