...
hours, demo your running code, and answer some questions. You may notice
sections of this assignment which provide extra space for an answer. While it
is not necessary to add code directly to this PDF, it will make grading in
office hours quicker if your answers are written and prepared in some way.
