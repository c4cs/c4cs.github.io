...
\author{\textbf{\color{red}{Solutions}}}
\date{}
\maketitle
...
\url{https://stackoverflow.com/research/developer-survey-2017}
...
\begin{quote}
  \color{violet}
  \texttt{cppcheck} can find the last bug. \texttt{scan-build} can't find
  either bug.
