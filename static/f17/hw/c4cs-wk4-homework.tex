...
%%% TODO: Change the semester [and revision]
...
%%% TODO: Change the week number and due date
\title{\textbf{Homework 4\\Editors}}
\author{\textbf{\color{red}{Due: Wednesday, October 11, 11:59PM (Hard Deadline)}}}
\date{}
\maketitle


%%% TODO: Edit course code from Gradescope
